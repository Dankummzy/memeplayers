...
SECRET_KEY = 'django-insecure-je48&k=0h%zbk*3^%@hi1*c14y-f31dei2*@#d7fjg1sug45%u'
...
CORS_ALLOWED_ORIGINS = [
    "http://localhost:3000",
    # "https://memeplayers.com",
]

ROOT_URLCONF = 'memeplayers.urls'
...
WSGI_APPLICATION = 'memeplayers.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'Memeplayers API',
    'DESCRIPTION': 'API documentation for Memeplayers',
    'VERSION': '1.0.0',
...
SIMPLE_JWT = {
    ...
    'AUTH_HEADER_TYPES': ('Bearer',),  # Set the prefix to Bearer
